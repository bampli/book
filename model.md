...
The Administration should confront plan with reality and promote actions when there are differences. Operating Expenses should be fed into the Company, including Labor and Overhead. Return on Investment flows to the owner when Net Profit is available.
